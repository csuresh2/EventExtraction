...
public class CosineSimilarity {
	 ...
	 * 
	 * @param firstFeatures
	 *            The feature vector of the first cluster
	 * @param secondFeatures
	 *            The feature vector of the second cluster
	 * @return the similarity measure
	 */
	public static Double calculateCosineSimilarity(HashMap<String, Double> firstFeatures,
		...
		// the first part of the denominator of the cosine similarity
		Double fnorm = 0.0;
		// the second part of the denominator of the cosine similarity
		Double snorm = 0.0;
	 ...
	 * 
	 * @param feature vector of one cluster
	 * @return
	 */
